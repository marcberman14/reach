                ...
                <div class="box-content">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <h2 class="panel-title">Lesson Creation Wizard</h2>
                        </header>
                        <div class="panel-body">
                                <form action="/assets/includes/process_lessoncreate.php" method="post" name="lessoncreateform" id="lessoncreateform">

                                <div class="panel-body">
                                    <div class="alert alert-success hidden" id="contactSuccess">Success! A lesson has been successfully create and assigned to a subject.</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="" class="form-control" name="lesson_title" id="lesson_title" placeholder="Enter the title of the lesson to create">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="lesson_name">Lesson Name:</label>
                                    <div class="col-sm-9">
                                        <input type="text" value="" class="form-control" name="lesson_name" id="lesson_name" placeholder="Enter the name of the lesson to create">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="lesson_description" id="lesson_description" placeholder="Enter the description of the lesson here"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="lesson_material" id="lesson_material" placeholder="Enter the material of the lesson here"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="" class="form-control" name="lesson_concept" id="lesson_concept" placeholder="Enter the concept of the lesson to create">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label" for="lesson_concept">YouTube Link:</label>
                                    <div class="col-sm-9">
                                        <input type="text" value="" class="form-control" name="video_link" id="video_link" placeholder="Enter the concept of the lesson to create">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="submit" id="submit" name="submit" value="Create Lesson" class="btn btn-primary push-bottom">
                                            </div>
                                        </div>
                                    </div>
                                </div>
