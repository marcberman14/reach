                ...
                <div class="box-content">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                               <form class = form-horizontal action="/assets/includes/process_newquiz.php?testname=<?php echo urlencode($_GET["testname"]) ?>&id=<?php echo urlencode($_GET["id"]) ?>" method="post" name="test" id="test">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" value="" class="form-control" name="question" id="question" placeholder="Enter the question"></textarea>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="" class="form-control" name="answer1" id="answer1" placeholder="Enter a possible answer">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="" class="form-control" name="answer2" id="answer2" placeholder="Enter a possible answer">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="answer3" id="answer3" placeholder="Enter a possible answer">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="" class="form-control" name="answer4" id="answer4" placeholder="Enter a possible answer">
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="submit" id="submit" name="submit" value="Create Question" class="btn btn-primary push-bottom">
                                            </div>
                                        </div>
                                    </div>
                                </div>
