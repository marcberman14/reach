                            ...
                            <ul class="nav nav-main">
                                ...
                                <li class="nav-parent">
                                    ...
                                    <ul class="nav nav-children">
                                        ...
                                        <li>
                                            <a href="/portal/test/new-test/">Create Test</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-primary">
                                ...
                                <form class = form-horizontal action="/assets/includes/process_question.php" method="post" name="test" id="test">
                                  <div class = "panel panel-body">
                                        
                                        <!--<fieldset>
                                        <div class="col-md-12 col-md-offset-0.5">                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="$question">Enter Question</label>
                                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-12 col-md-offset-0.5">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="canswer">Enter Correct Answer</label>
                                                    <div class="col-md-8">
                                                        <input type="text" value="" class="form-control" name="canswer" id="canswer">
                                                    </div>                
                                            </div>
                                        </div>
                                        </fieldset>
                                        ...
                                        <div class="col-md-12 col-md-offset-0.5">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="wanswer1">Enter First Wrong Answer</label>
                                                    <div class="col-md-8">
                                                        <input type="text" value="" class="form-control" name="wanswer1" id="wanswer1">
                                                    </div>                
                                            </div>
                                        </div>
                                        </fieldset>
                                        ...
                                        <div class="col-md-12 col-md-offset-0.5">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="wanswer2">Enter Second Wrong answer</label>
                                                    <div class="col-md-8">
                                                        <input type="text" value="" class="form-control" name="wanswer2" id="wanswer2">
                                                    </div>                
                                            </div>
                                        </div>
                                        </fieldset>
                                        ...
                                        <div class="col-md-12 col-md-offset-0.5">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="wanswer3">Enter Third Wrong answer</label>
                                                    <div class="col-md-8">
                                                        <input type="text" value="" class="form-control" name="wanswer3" id="wanswer3">
                                                    </div>                
                                            </div>
                                        </div>
                                        </fieldset>
                                        ...
                                        <div class="col-md-12 col-md-offset-0.5">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="test">Enter test id</label>
                                                    <div class="col-md-8">
                                                        <input type="text" value="" class="form-control" name="test" id="test">
                                                    </div>                
                                            </div>
                                        </div>
                                        </fieldset>-->
