                    ...
                    <div class="panel-body">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-md">
                                        <form method="POST" action="../new-test/index.php?id=<?php echo $_REQUEST['subjectid'] ?>">
   ...
   (function( $ ) {
        ...
        var datatableInit = function() {
            ...
            $table.dataTable({
                ...
                bProcessing: true,
                sAjaxSource:  "/assets/datatables/tests/tests.php?subjectid=<?php echo $_GET['subjectid'] ?>",
                "aoColumns": [
                    { "mData": "Test Name"},
