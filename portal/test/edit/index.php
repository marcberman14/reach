<?php
    ...
    if($login['response'] != "error") {
		...
		$array = array("testid"=>$_REQUEST['id']);
		
		$one = $test->getTest($array);
		
		
		//var_dump($one['test_name']);
?>
        ...
        <section role="main" class="content-body">
            ...
            <div class="box-content">
                <section class="panel">
                    ...
                    <form class = form-horizontal action="/assets/includes/process_testedit.php?id=<?php echo $_REQUEST['id']; ?>" method="post" name="test" id="testcreateform">   
                                    ...
                                    <div class = "panel panel-body">
                                        ...
                                        <div class="col-md-12 col-md-offset-0.5">                                            
                                            ...
                                            <input type="hidden" value="<?php echo $_REQUEST['id']; ?>"  name="subid" id="subid">
                                                ...
                                                <label class="col-md-3 control-label" for="test_name">Enter Test Name</label>
                                                    <div class="col-md-8">
                                                        <input type="text" value="<?php echo $one[0]['test_name']; ?>" class="form-control" name="test_name" id="test_name">
                                                        </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea type="text" value="" class="form-control" name="test_description" id="test_description"><?php echo $one[0]['test_description']; ?></textarea>
                                                        </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" value="<?php echo $one[0]['test_marks']; ?>" class="form-control" name="test_marks" id="test_marks">
                                                    </div>              
                                            </div>
                                        </div>
                                        </fieldset>                                            
