...
<section role="main" class="content-body">
    ...
    <section class="panel">
     ...
     <header class="panel-heading">
        <h2 class="panel-title">Results : <?php echo urlencode($_GET['marks']);  echo "/"; echo  $testing[0]['test_marks']; ?></h2>
    </header>
   ...
   (function( $ ) {
        ...
        var datatableInit = function() {
            ...
            $table.dataTable({
                ...
                bProcessing: true,
                sAjaxSource: "/assets/datatables/result/results.php?marks=<?php echo urlencode($_GET['marks']); ?>&testid=<?php echo urlencode($_GET['testid']); ?>",
                "aoColumns": [
