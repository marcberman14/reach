...
?>
            ...
            <section role="main" class="content-body">
                ...
                <section class="panel">
                    ...
                    <p>
                        <h2 class="panel-title">Profile Edit &nbsp;<a href="../edit/index.php?id=<?php echo $identity; ?>&type=<?php echo $type; ?>" class="on-default edit-row" title="Edit"><i class="fa fa-2x fa-history"></i></a></h2>
                    </p>

                    </header>

                    <form action="/assets/includes/process_useredit.php?id=<?php echo $identity; ?>&type=<?php echo $type; ?>" method="POST" id="usereditform" name="usereditform">
                     ...
                     <div class="form-group">
                                ...
                                <div class="form-group">
									...
									if($user->getUserActive() == "active"){
                                                    echo '<select class="form-control input-lg" name="active" id="active">
                                ...
                                <div class="form-group">
									...
									<?php
												...
												if($user->getGender() == 'Female'){
                                                    echo '<select class="form-control input-lg" name="gender" id="gender">
