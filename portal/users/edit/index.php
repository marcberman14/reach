...
if($permis == 1){
    ...
    $profile=$member->allAdministrators($array);
}
...
?>
            ...
            <section role="main" class="content-body">
                ...
                <section class="panel">
                    ...
                    <p><h2 class="panel-title">Profile Edit &nbsp;<a href="../edit/index.php?id=<?php echo $identity; ?>&type=<?php echo $permis; ?>" class="on-default edit-row" title="Edit"><i class="fa fa-history"></i></a></h2></p>
                    </header>
                    <form action="/assets/includes/process_useredit.php?id=<?php echo $identity; ?>&type=<?php echo $permis; ?>" method="POST" id="<?php echo $formname; ?>" name="<?php echo $formname; ?>">
                    ...
                    <div class="alert alert-danger hidden" id="contactError">Error!</div>
                     <div class="form-group">
                                        ...
                                        <div id="dob">
                                            <div class="input-group date">
                                                <input type="text" class="form-control" id="dob"
                                                       name="dob"
                                                       placeholder="Select the date of birth" value="'.$profile['dob'].'">
								...
								echo '<div class="form-group">
                                    ...
                                    "/assets/ajax/usermanagement/student.js"));
								...
								echo '<div class="form-group">
									...
									<select class="form-control" name="tutnationality" id="tutnationality">
								...
								echo '<div class="form-group">
									...
									<select class="form-control" name="tutcountryofres" id="tutcountryofres">
                                                                        <option value="'.$profile['countryresidence'].'">'.$profile['countryresidence'].'</option>
                                                                        <option value="South Africa">South Africa
                                                                        </option>
                                                                        <option value="Afghanistan">Afghanistan</option>
                                                                        <option value="Aland Islands">Aland Islands
								...
								echo '<div class="form-group">
                                    ...
                                    echo $views->addScript(Array(
                                    "/assets/ajax/usermanagement/tutor.js"));
                                ...
                                echo $views->addScript(Array(
                                    "/assets/ajax/usermanagement/teacher.js"));
								...
								echo '<div class="form-group">
									...
									<input type="text"class="form-control" name="adminsuburb" id="adminsuburb" value="'.$profile['suburb'].'">
								...
								echo '<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
									<input type="text"class="form-control" name="adminpostalcode" id="adminpostalcode" value="'.$profile['postalcode'].'">
                                    </div>
                                </div>';

								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teaschooladdress">Home Number:</label>
                                    <div class="col-sm-9">
									<input type="text"class="form-control" name="adminhomenumber" id="adminhomenumber" value="'.$profile['homenumber'].'">
                                    </div>
                                </div>';

								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teaschoolcontact">Cellphone Number:</label>
                                    <div class="col-sm-9">

									<input type="text"class="form-control" name="admincellphone" id="admincellphone" value="'.$profile['cellphone'].'">
								...
								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teastreetno">Work Number:</label>
                                    <div class="col-sm-9">

									<input type="text"class="form-control" name="adminworknumber" id="adminworknumber" value="'.$profile['worknumber'].'">
								...
								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teastreetname">Monash Staff Number:</label>
                                    <div class="col-sm-9">

									<input type="text"class="form-control" name="adminstaffnumber" id="adminstaffnumber" value="'.$profile['staffnumber'].'">
								...
								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teasuburb">Department of Work:</label>
                                    <div class="col-sm-9">


									<input type="text"class="form-control" name="adminjobdepartment" id="adminjobdepartment" value="'.$profile['jobdepartment'].'">
								...
								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teacity">Position in Department:</label>
                                    <div class="col-sm-9">

									<input type="text"class="form-control" name="adminjobposition" id="adminjobposition" value="'.$profile['jobposition'].'">
								...
								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teapostcode">Monash Email Address:</label>
                                    <div class="col-sm-9">
									<input type="text"class="form-control" name="adminmonashmail" id="adminmonashmail" value="'.$profile['monashmail'].'">
                                    </div>
                                </div>';

								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teapostcode">Alternative Email Address:</label>
                                    <div class="col-sm-9">
									<input type="text"class="form-control" name="adminalternativeemail" id="adminalternativeemail" value="'.$profile['alternativeemail'].'">
                                    </div>
                                </div>';

								echo '<div class="form-group">
                                    <label class="col-sm-3 control-label" for="w3-teasubtaught">Alternative Contact Number:</label>
                                    <div class="col-sm-9">
									<input type="text"class="form-control" name="adminaltcontactnum" id="adminaltcontactnum" value="'.$profile['altcontactnum'].'">
                                    </div>
                                </div>

                                ';
                                echo $views->addScript(Array(
                                    "/assets/ajax/usermanagement/admin.js"));
									 } ?>
								<div class="form-group">
                                    <div class="col-sm-12">
									    <input type="submit" id="submit" name="submit" value="Edit user" class="btn btn-primary push-bottom"> <a href="../view/" class="btn btn-primary push-bottom">Return to Users</a>
                                    </div>
                                </div>
...
echo $views->addScript(Array("/assets/vendor/jquery/jquery.js",
    ...
    "/assets/ajax/usermanagement/noprofile.js"));
    }else {
        ?>
        <script>
...
<script>
    var	myNodelist = document.getElementsByTagName("input");
    var i;
