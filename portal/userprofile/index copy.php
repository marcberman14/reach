            ...
            <section role="main" class="content-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php
$id=$_SESSION['user_id'];
$stmt = $mysqli->prepare("SELECT user_id, permission_id, firstname, lastname, email from members where user_id=?");
$stmt -> bind_param('s', $user_id);
$stmt -> execute();
$stmt->store_result();


$stmt -> bind_result($user_id, $permission_id, $firstname, $lastname, $email);
$stmt -> fetch();
?>
