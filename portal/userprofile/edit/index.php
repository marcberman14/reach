...
include_once $_SERVER['DOCUMENT_ROOT']."/assets/php/classes/Student.php";

sec_session_start();
//$data = $_SESSION['user']->pullUser();
$student = new Student();
$sdata = $student->pullStudent($_SESSION['user_id']);
...
<?php } else if($login['response'] == 'success') { ?>
                        ...
                        <section class="body">
                            ...
                            <li><span>Default</span></li>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form action="/assets/includes/process_editstudent.php" method="post" name="studentprofile" id="studentprofile">
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" value="<?php echo $sdata['streetnumber']; ?>" class="form-control input-lg" name="stustreetno" id="stustreetno">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" value="<?php echo $sdata['streetname']; ?>" class="form-control input-lg" name="stustreetname" id="stustreetname">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <label>Suburb:</label>
                                                            <input type="text" value="<?php echo $sdata['suburb']; ?>" class="form-control input-lg" name="stusuburb" id="stusuburb">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <label>City:</label>
                                                            <input type="text" value="<?php echo $sdata['city']; ?>" class="form-control input-lg" name="stucity" id="stucity">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="text" value="<?php echo $sdata['postalcode']; ?>" class="form-control input-lg" name="stupostcode" id="stupostcode">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $sdata['homenumber']; ?>" class="form-control input-lg" name="stuhomeno" id="stuhomeno">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Cell Phone Number:</label>
                                                            <input type="text" value="<?php echo $sdata['cellnumber']; ?>" class="form-control input-lg" name="stucellno" id="stucellno">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $sdata['alternativenumber']; ?>" class="form-control input-lg " name="stualtno" id="stualtno">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Parent Cell Phone Number:</label>
                                                            <input type="text" value="<?php echo $sdata['parentnumber']; ?>" class="form-control input-lg" name="stuparentno" id="stuparentno">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                        <div class="form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" value="<?php echo $sdata['schoolname']; ?>" class="form-control input-lg" name='stuschoolname' id='stuschoolname'>
                                                            </div>
                                                        </div>
                                                    </div>
