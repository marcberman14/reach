                        ...
                        <div class="col-sm-12">
                            <div class="featured-box featured-box-secundary default info-content">
                                <div class="box-content">
                                    ...
                                    $usertype = $_SESSION['user']->getPermissionName();
                                    if ($usertype == 'Student') { ?>
                            ...
                            elseif ($usertype == 'Administrator') { ?>
                                ...
                                <script type="text/javascript">
                                    ...
                                    $(document).ready(function () {
                                        ...
                                        $('#admdateofbirth .input-group.date').datepicker({
                                            format: "yyyy-mm-dd",
                                            startView: 2,
                                            calendarWeeks: true,
                                            autoclose: true,
...
<?php
include($_SERVER['DOCUMENT_ROOT']."/assets/php/views/footer-home-profile.php");
?>
</body>
</html>