                ...
                if ($sec_data['password'] == $password) {
                    ...
                    if ($sec_data['active'] == "active"){
                        if ($sec_data['permission_name'] == "Student"){
                            ...
                            $member = new Student($sec_user['user_id'], $sec_user['studentId'], $sec_user['firstname'], $sec_user['lastname'], $sec_user['email'], $sec_user['active'], $sec_user['permission_name'],
                            ...
                            $member = new Tutor($sec_user['user_id'], $sec_user['tutor_id'], $sec_user['firstname'], $sec_user['lastname'], $sec_user['email'], $sec_user['active'], $sec_user['permission_name'],
                                ...
                                $sec_user['studyarea'], $sec_user['studyyear'], $sec_user['studentnumber'], $sec_user['personalemail'], $sec_user['gender'], $sec_user['monashemail'],
                            ...
                            $member = new Teacher($sec_user['user_id'], $sec_user['teacherId'], $sec_user['firstname'], $sec_user['lastname'], $sec_user['email'], $sec_user['active'], $sec_user['permission_name'],
                            ...
                            $member = new Admin($sec_user['user_id'], $sec_user['adminId'], $sec_user['firstname'], $sec_user['lastname'], $sec_user['email'], $sec_user['active'], $sec_user['permission_name'],
                                $sec_user['dob'], $sec_user['gender'], $sec_user['streetnumber'], $sec_user['streetname'], $sec_user['suburb'], $sec_user['city'], $sec_user['country'], $sec_user['postalcode'],
                    ...
                    } else if ($sec_data['active'] == "noprofile" || $sec_data['active'] == "notapproved" || $sec_data['active'] == "inactive" || $sec_data['active'] == "invalid") {
                        $member = new User($sec_data['user_id'], $sec_data['firstname'], $sec_data['lastname'], $email, $sec_data['active'], $sec_data['permission_name']);
                    }
                    $_SESSION['login_string'] = hash('sha512', $password . $user_browser);
                    $_SESSION['user'] = $member;
