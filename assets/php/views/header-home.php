                ...
                <nav class="nav-main mega-menu">
                    <ul class="nav nav-pills nav-main" id="mainMenu">
                                                    ...
                                                    <div class="user-avatar">
                                                        <div class="img-thumbnail">
                                                            <figure class="profile-picture">
                                                                <img
                                                                    src="/bin/user-profile/<?php echo $_SESSION['user']->getPicUrl(); ?>"
                                                                    alt="<?php echo htmlentities($_SESSION['user']->getUserfirstname()) . ' ' . htmlentities($_SESSION['user']->getUserlastname()); ?>"
                                                                    class="img-circle"
                                                                    data-lock-picture="/bin/user-profile/<?php echo $_SESSION['user']->getPicUrl(); ?>"/>
                                                            </figure>
                                                        </div>
                                                        <p>
                                                            <strong><?php echo htmlentities($_SESSION['user']->getUserfirstname()) . ' ' . htmlentities($_SESSION['user']->getUserlastname()); ?></strong><span><?php echo htmlentities($_SESSION['user']->getPermissionName()); ?></span>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                        ...
                        <?php } else { ?>
                            ...
                            <li class="dropdown mega-menu-item mega-menu-signin signin hidden-xs hidden-sm"
                                id="headerAccount">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="signin-form">
                                                        ...
                                                        <p class="sign-up-info">Don't have an account yet? <a
