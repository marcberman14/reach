                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getStreetNumber() ?>"
                                               class="form-control" name="teastreetno" id="teastreetno">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getSuburb() ?>"
                                               class="form-control" name="teasuburb" id="teasuburb">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getCity() ?>"
                                               class="form-control" name="teacity" id="teacity">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getPostalCode() ?>"
                                               class="form-control" name="teapostcode" id="teapostcode">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getCellNumber() ?>"
                                               class="form-control" name="teacellno" id="teacellno">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text"
                                               ...
                                               class="form-control" name="teaaltno" id="teaaltno">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="profileAddress">Current Employed
                                        School</label>

                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getSchoolemployed() ?>"
                                               class="form-control" name="teaschoolemp" id="teaschoolemp">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="profileAddress">Current Grade
                                        Taught</label>

                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getTeachingGrade() ?>"
                                               class="form-control" name="teagradtaught" id="teagradtaught">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="profileAddress">Current Subject
                                        Taught</label>

                                    <div class="col-md-8">
                                        <input type="text" value="<?php echo $_SESSION['user']->getSubjectTaught() ?>"
                                               class="form-control" name="teasubtaught" id="teasubtaught">
                                    </div>
                                </div>
...
<?php echo $views->addScript(Array("/assets/ajax/userprofile/teacher.js",
